...
object ShizukuHelper {
    ...
    private val binderReceivedListener = Shizuku.OnBinderReceivedListener {
        ...
        binderAlive = true
        // Khi tính năng tối ưu đang khoá tạm thời, không tự xin quyền hay bind
        // service — chỉ cập nhật trạng thái hiển thị "Connected" cho vui mắt.
        if (!AppConfig.OPTIMIZATION_LOCKED && checkPermission()) bindService()
